...
#CGO_ENABLED=1 CC=aarch64-linux-android28-clang CXX=aarch64-linux-android28-clang GOOS=android GOARCH=arm64 go install std

#CGO_ENABLED=1 CC=aarch64-linux-android28-clang GOOS=linux GOARCH=arm64 go install std
